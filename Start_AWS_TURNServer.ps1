...
#$tmpData = Get-NetIPAddress -InterfaceIndex 4
#$LocalIp = $tmpData.IPAddress[1]

$tmpData = Get-NetIPAddress -InterfaceAlias "Ethernet 3" -AddressFamily IPv4
$LocalIp = $tmpData.IPAddress
